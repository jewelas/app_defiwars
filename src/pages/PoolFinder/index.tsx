import { Currency, ETHER, JSBI, TokenAmount, Token, Pair } from '@pancakeswap-libs/sdk'
...
import { usePairAdder, toV2LiquidityToken } from 'state/user/hooks'
...
export default function PoolFinder() {
  ...
  const position: TokenAmount | undefined = useTokenBalance(account ?? undefined, token0 && token1 && toV2LiquidityToken(token0.sortsBefore(token1) ? [token0, token1] : [token1, token0]))
